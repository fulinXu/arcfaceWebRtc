...
import com.landsky.videoimageshot.exception.CodecNotFoundExpception;
import com.landsky.videoimageshot.exception.FileNotOpenException;
import com.landsky.videoimageshot.exception.StreamInfoNotFoundException;
import com.landsky.videoimageshot.exception.StreamNotFoundException;
...
//			av_free(buffer);//Don't free buffer
	...
	protected abstract ByteBuffer saveFrame(AVFrame pFrameRGB, Integer width, Integer height);
